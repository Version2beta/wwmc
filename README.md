...
~~~sh
# getting the code
git clone git@github.com:nko4/wwmc.git && cd ./wwmc/

# developing
npm install
npm start

# deploying (to http://wwmc.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@wwmc.2013.nodeknockout.com
ssh root@wwmc.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@wwmc.2013.nodeknockout.com
ssh -i ./id_deploy root@wwmc.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/wwmc" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
